...
import com.pride.adapter.CategoryListAdapter;
...
import com.pride.util.OnLoadMoreListener;
...
public class AllPlacesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(requireActivity())) {
            new getAllPlace(API.toBase64(jsObj.toString())).execute(Constant.API_URL);
         }
    ...
    private class getAllPlace extends AsyncTask<String, Void, String> {

        String base64;

        private getAllPlace(String base64) {
            this.base64 = base64;
        }
                    ...
                    if (Constant.SAVE_ADS_NATIVE_ON_OFF.equals("true")) {
                        for (int i = 0; i < mCategoryList.size(); i++) {
                            if (i % Integer.parseInt(Constant.SAVE_NATIVE_CLICK_OTHER) == 0) {
                                ItemPlaceList itemMostView = new ItemPlaceList();
                                itemMostView.setIsads(true);
                                if (!mCategoryList.get(i).isIsads()) {
                                    mCategoryList.add(i, itemMostView);
                                }
                            }
                        }
