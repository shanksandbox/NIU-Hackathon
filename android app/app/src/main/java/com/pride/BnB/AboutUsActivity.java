...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(AboutUsActivity.this)) {
            new getAbout(API.toBase64(jsObj.toString())).execute(Constant.API_URL);
        }

    }

    @SuppressLint("StaticFieldLeak")
    private class getAbout extends AsyncTask<String, Void, String> {

        String base64;

        private getAbout(String base64) {
            this.base64 = base64;
        }
