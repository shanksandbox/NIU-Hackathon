...
public class PrivacyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(PrivacyActivity.this)) {
            new getPrivacyData(API.toBase64(jsObj.toString())).execute(Constant.API_URL);
        }
    }

    @SuppressLint("StaticFieldLeak")
    private class getPrivacyData extends AsyncTask<String, Void, String> {

        String base64;

        private getPrivacyData(String base64) {
            this.base64 = base64;
        }
