...
public class HomePopularAdapter extends RecyclerView.Adapter<HomePopularAdapter.ItemRowHolder> {
    ...
    public HomePopularAdapter(Activity context, ArrayList<ItemPlaceList> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_home_popular_item, parent, false);
